...
public class FetchurData {
    ...
    private static final String[][] ITEMS = {{"Yellow Stained Glass", "x20"}, {"Compass", "x1"}, {"Mithril", "x20"}, {"Firework Rocket", "x1"}, {"Coffee", "x1 (Cheap/Decent/Black)"}, {"Wooden Door", "x1 (any type)"}, {"Rabbit's Foot", "x3"}, {"Superboom TNT", "x1"}, {"Pumpkin", "x1"}, {"Flint and Steel", "x1"}, {"Nether Quartz Ore", "x50"}, {"Red Wool", "x50"},};
